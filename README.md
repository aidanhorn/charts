...
|---|---|---|---|---|
| Crypto (BTC/USD, log scale) | `scripts/crypto_btc.R` | [CoinGecko](https://www.coingecko.com/en/api) (free tier) | Daily | Live |
| Climate (global PM2.5 air quality) | `scripts/climate_air_quality.R` | [OpenAQ](https://openaq.org/) v3 API (needs a free `OPENAQ_API_KEY` repo secret) | Daily | Live |
| Commodities (Brent crude oil) | `scripts/commodities_oil.R` | [FRED](https://fred.stlouisfed.org/) (free CSV, no key) | Daily | Live |
| Energy (generation mix by country) | `scripts/energy_generation_mix.R` | [Our World in Data](https://github.com/owid/energy-data) energy dataset (Ember's own site blocks programmatic access) | Monthly | Live |
| Real estate (real house-price growth, major markets) | `scripts/real_estate_house_prices.R` | [OECD](https://data-explorer.oecd.org/) Analytical House Prices Indicators (SDMX REST API, no key) | Quarterly | Live |
